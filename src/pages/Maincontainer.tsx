...
const Maincontainer = () => {
  ...
  return (
    <div className="grid grid-cols-12 bg-[#0d0d0d] min-h-screen  shadow-lg">
      {/* Sidebar */}
      <div className="col-span-12 md:col-span-3 min-h-screen mb-3 bg-[#1a1a1a] text-white p-6 rounded-lg shadow-xl flex flex-col justify-between">
        <div>
        ...
        <div className="p-4 text-gray-400 mb-1 text-sm bg-[#262626] rounded-lg shadow-md">
          {userEmail ? (
            <>
            ...
            <div>
              <p>Not Signed In</p>
              <Button color="secondary" className="mt-2" onPress={() => Navigate('/')}>
                Sign In
              </Button>
            </div>
          )}
      ...
      {/* Main Content */}
      <div className="col-span-12 md:col-span-9 bg-[#121212] min-h-screen text-gray-300 p-8 rounded-lg shadow-xl">
